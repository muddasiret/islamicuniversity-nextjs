...
const Programmes = ({ programmes, global }) => {
  let title_image = getTitleImage(global, "PROGRAMMES");
  let page_desc = getPageDescription(global, "PROGRAMMES");

  return (
    <Layout>
      <PageTitle title="PROGRAMMES" title_image={title_image} />
      <MainLayout>
